...
?>
<div class="mainWrap single movie recipe">
            <div class="mainArea">
                <section class="postArea">
                    ...
                    <div class="contentArea">
                        <?php //if($movie_cat[0]->slug === 'recipe') { ?>
                ...
                <section class="articleListArea rankingListArea">
                    <h1 class="heading">
                        <span>R</span><span>E</span><span>C</span><span>I</span><span>P</span><span>E</span><br>
                    ...
                    <div class="tabs">
                        ...
                        <div class="tabContentArea">
                            <div id="content-tab-1" class="tabContent">
                                <ul class="articleList movieList recipe">
