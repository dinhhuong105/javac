...
<div id="sb-site" class="wrapper single movie">
    <?php breadcrumb(); ?>
    <article class="singleArea movie">
        <?php if (have_posts()) : ?>
        ...
        <?php
            $mv = get_post_meta($post->ID, 'movie', true);
        ?>
        <?php if(empty($mv)) { ?>
        ...
        <div class="writerArea">
            <a href="<?php echo home_url('/'); ?>author/<?php echo $author->user_nicename; ?>?uID=<?php echo $author->ID; ?>&uNAME=<?php echo $author->display_name; ?>&tab=recipe">
                <?php
    ...
    <section class="rankingArea movie">
        <h1 class="heading">
            <span>R</span><span>E</span><span>C</span><span>I</span><span>P</span><span>E</span><br><span>R</span><span>A</span><span>N</span><span>K</span><span>I</span><span>N</span><span>G</span>
        </h1>
        <div class="tabs">
            ...
            <div class="tabContentArea">
                <div id="content-tab-1" class="tabContent">
                    <ul class="movieList recipe ranking">
