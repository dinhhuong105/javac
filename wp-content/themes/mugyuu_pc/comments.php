		...
		<?php
	        ...
	        $args = array(
	                    'fields' => array(
	                        ...
	                        'title' => '<p class="title"><label for=“title">タイトル<span class="required">*</span></label><input name="title" type="text" placeholder="タイトルを入力してください" id="title" aria-required="true"></p>'
	                    ),
